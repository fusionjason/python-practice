...
def add_assignment(conn, title, class_name, due_date):
    cursor = conn.cursor()
...
def delete_assignment(conn, title):
    cursor = conn.cursor()
...
def mark_class_done(conn, class_name):
    cursor = conn.cursor()
...
if __name__ == "__main__":
    while True:
        choice = input("do you want to add, list, delete, done, not done, filter by class, edit due date, delete by class, mark class done or quit? ").lower()
        ...
        if choice == "add":
            ...
            for entry in entries:
                ...
                add_assignment(conn, title, class_name, due_date)
